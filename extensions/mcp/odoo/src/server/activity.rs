//! `activity_list` — the scheduled work Odoo has assigned to the caller.
//!
...
//! addressed to a *person*, and this tool only ever answers for the caller.
...
use crate::tools::TOOL_ACTIVITY_LIST;
use crate::tools::inputs::{ActivityListInput, resolve_limit};
