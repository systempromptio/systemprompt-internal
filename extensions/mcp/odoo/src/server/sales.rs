...
use super::sales_shape::{INVOICE_FIELDS, ORDER_FIELDS};
...
use crate::tools::inputs::{
    InvoiceGetInput, InvoiceListInput, SaleOrderCreateInput, SaleOrderGetInput, SaleOrderListInput,
    resolve_limit,
};
use crate::tools::{
    TOOL_INVOICE_GET, TOOL_INVOICE_LIST, TOOL_SALE_ORDER_CREATE, TOOL_SALE_ORDER_GET,
