//! Entry point for the `odoo` MCP server binary.
...
use systemprompt_mcp_odoo::OdooServer;
use tokio::net::TcpListener;

const DEFAULT_SERVICE_ID: &str = "odoo";
