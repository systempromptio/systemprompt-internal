...
pub mod internals {
    pub use crate::categorize_output::{
        CATEGORIES, Categorization, Category, SCHEMA_NAME, correction_prompt, parse_output,
        response_format, response_schema, structured_json, structured_output_options,
